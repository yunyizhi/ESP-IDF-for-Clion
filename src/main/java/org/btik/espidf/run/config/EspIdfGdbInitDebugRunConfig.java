...
public class EspIdfGdbInitDebugRunConfig extends CLionRunConfiguration<EspIdfBuildConf, EspIdfBuildTarget> {

    private ExecutableData executableData;
    private DebugConfigModel configDataModel;

    public EspIdfGdbInitDebugRunConfig(Project project, ConfigurationFactory factory) {
        super(project, factory, $sys("esp.idf.debug.gdbinit.name"));
    }

    @Override
    public @NotNull SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
        return new EspIdfGdbInitDebugSettingEditor(getProject());
    }
